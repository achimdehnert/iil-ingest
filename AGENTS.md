...
Ein Kommando, frischer Clone, Python >=3.11:
...
Extras: `iil-ingest[all]`, `iil-ingest[dev]`, `iil-ingest[django]`, `iil-ingest[docx]`, `iil-ingest[excel]`, `iil-ingest[ocr]`, `iil-ingest[pdf]`
